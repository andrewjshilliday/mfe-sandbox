...
const StatusFilter = ({ value: status, onChange }) => {
  ...
  return (
    <div className={`${styles.filters} ${styles.statusFilters}`}>
...
const ColorFilters = ({ value: colors, onChange }) => {
  ...
  return (
    <div className={`${styles.filters} ${styles.colorFilters}`}>
      <h5>Filter by Color</h5>
      <form className={styles.colorSelection}>{renderedColors}</form>
    </div>
  )
}
  ...
  return (
    <footer className={styles.footer}>
      <div className={styles.actions}>
        <h5>Actions</h5>
        <button className={styles.button} onClick={onMarkCompletedClicked}>
          Mark All Completed
        </button>
        <button className={styles.button} onClick={onClearCompletedClicked}>
          Clear Completed
        </button>
      </div>
